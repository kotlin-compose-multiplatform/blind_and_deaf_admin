        ...
        <BrowserRouter>
          <Routes>
            <Route path="/" element={<Index />}>
              ...
              <Route
                path={"/project"}
                element={<Project isProject={true} isProduct={false} />}
              />
              <Route
                path={"/product"}
                element={<Project isProject={false} isProduct={true} />}
              />
              <Route path={"/certificate"} element={<Certificate />} />
              <Route path={"/settings"} element={<Settings />} />
              <Route
                path={"/about"}
                element={<About is_partner={false} type={0} />}
              />
              <Route
                path={"/links"}
                element={<About is_partner={false} type={1} />}
              />
              <Route
                path={"/partners"}
                element={<About is_partner={true} type={2} />}
              />
              <Route
                path={"/parts"}
                element={<About is_partner={false} type={3} />}
              />
              <Route
                path={"/other_about"}
                element={<About is_partner={false} type={4} />}
              />
              <Route
                path={"/banner"}
                element={<About is_partner={false} type={5} />}
              />
            </Route>
